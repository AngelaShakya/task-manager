    ...
    <div class="form-box">
        <form method="POST" action="{{route('tasks.update',$task)}}" class="edit-task">
            ...
            <div class="item mb-4">
                ...
                <input type="number" class="form-control" name="priority" min="1" value="{{ old('priority', $task->priority) }}"/>
                <small class="text-danger">
                    <i>
            ...
            <div class="item mb-4">
                ...
                <select name="project" class="form-control">
                    ...
                    <option name="project" value="{{$project->id}}" selected="{{ $task->project_id === $project->id ? 'selected' : '' }}">{{$project->name}}</option>
                    @endforeach
                </select>
                <small class="text-danger">
                    <i>
